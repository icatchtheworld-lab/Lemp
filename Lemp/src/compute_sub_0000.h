...
/*
 kBufferSize_sub_0000_book_face_v5 is a compile-time constant to be used by the user of compute_sub_0000_book_face_v5 function
 ...
 Example of how to call the compute function:
   ...
   uint8_t my_buffer[kBufferSize_sub_0000_book_face_v5];

   int main() {
     ...
     compute_sub_0000_book_face_v5(my_buffer, input, output);
   }
*/
enum BufferSize_sub_0000_book_face_v5 {

#if defined(ARM_MATH_MVEI)
  kBufferSize_sub_0000_book_face_v5 = 196613

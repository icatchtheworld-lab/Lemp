...
#define CEU_VIO_D0 (BSP_IO_PORT_04_PIN_00)
#define CEU_VIO_D1 (BSP_IO_PORT_04_PIN_01)
#define PMOD1_RST (BSP_IO_PORT_04_PIN_02) /* Enable when connected */
#define AUDIO_BCLK (BSP_IO_PORT_04_PIN_03)
#define AUDIO_LRC (BSP_IO_PORT_04_PIN_04)
#define AUDIO_DIN (BSP_IO_PORT_04_PIN_05) /* See J41 in manual */
#define CEU_VIO_D3 (BSP_IO_PORT_04_PIN_06) /* See J41 in manual */
...
#define SPEAKER_AMP_SD (BSP_IO_PORT_05_PIN_15) /* Enable when connected */
...
#define CEU_VIO_D4 (BSP_IO_PORT_07_PIN_00) /* See SW4 in manual */
#define CEU_VIO_D5 (BSP_IO_PORT_07_PIN_01) /* See SW4 in manual */
#define CEU_VIO_D6 (BSP_IO_PORT_07_PIN_02) /* See SW4 in manual */
#define CEU_VIO_D7 (BSP_IO_PORT_07_PIN_03) /* See SW4 in manual */
#define PMOD2_GPIO2 (BSP_IO_PORT_07_PIN_04) /* Enable when connected */
#define ESP_UART_RX (BSP_IO_PORT_07_PIN_06)
#define ESP_UART_TX (BSP_IO_PORT_07_PIN_07)
#define CEU_VIO_VD (BSP_IO_PORT_07_PIN_08)
...
#define CEU_VIO_D2 (BSP_IO_PORT_09_PIN_09) /* See E24 in manual */
...
#define CAMERA_VSYNC (BSP_IO_PORT_11_PIN_02) /* See SW4 in manual */
